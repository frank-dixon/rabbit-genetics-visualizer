  ...
  return (
    <main className="flex-1 min-h-0 overflow-y-auto">
      <div className="max-w-3xl mx-auto p-4 pb-8 space-y-6 text-sm text-slate-700 dark:text-slate-300">
        ...
        <div className="space-y-4 [&_h2]:font-serif [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-ink dark:[&_h2]:text-ink [&_h2]:mt-6 [&_h2]:mb-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:space-y-2 [&_a]:text-sky-600 dark:[&_a]:text-sky-400 [&_a]:underline [&_a]:underline-offset-2 [&_strong]:text-slate-800 dark:[&_strong]:text-slate-100">
          {children}
        </div>
      </div>
    </main>
